...
namespace PayoutAplication.Models
{
    public class RequestFlow
    {
        ...
        public string RecordResponse(IPayPalSerializableObject responseObject)
        {
            if (responseObject != null && this.Items.Any())
            {
               return this.Items.Last().Response = Common.FormatJsonString(responseObject.ConvertToJson());
            }
            return null;
        }
